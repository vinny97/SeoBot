    ...
    <header className="sticky top-0 z-40 border-b border-[var(--flight-border)] bg-[var(--flight-bg)]/88 backdrop-blur-xl">
      <div className="mx-auto flex h-[74px] w-full max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:px-12">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="inline-flex items-center gap-2 text-xs font-medium text-[#438f5d]"><span className="relative grid h-2.5 w-2.5 place-items-center"><span className="flight-beacon absolute inset-0 rounded-full border border-[#4da56a]"/><span className="h-2 w-2 rounded-full bg-[#4da56a]"/></span>{snapshot?.searchIntelligence.agentStatus.replaceAll("_"," ")||"Agent active"}</span>
