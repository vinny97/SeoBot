...
describe("GSC security and matching",()=>{
  ...
  it("requires direct Google OAuth credentials and an encryption key",()=>{expect(getGscServerEnv({NODE_ENV:"test",NEXT_PUBLIC_APP_URL:"https://app.searchhand.test",GOOGLE_GSC_CLIENT_ID:"client-id-123",GOOGLE_GSC_CLIENT_SECRET:"client-secret-123",GOOGLE_GSC_REDIRECT_URI:"https://app.searchhand.test/app/integrations/google-search-console/callback",GSC_TOKEN_ENCRYPTION_KEY:"x".repeat(43)})).toMatchObject({APP_URL:"https://app.searchhand.test",GOOGLE_GSC_CLIENT_ID:"client-id-123"});expect(getGscServerEnv({NODE_ENV:"test"})).toBeNull()});
